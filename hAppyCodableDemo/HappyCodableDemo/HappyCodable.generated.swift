...
//
//  Created by 庄黛淳华 on 2020-08-01 14:32:56 +0000.
...
extension CodingKeysExistStruct {
	...
	func decode(happyFrom decoder: Decoder) throws {
		...
		do { self.int = try container.decode(default: self.int, key: "int_alter") } catch { errors.append(error) }
		do { self.string = try container.decode(default: self.string, key: "string_alter") } catch { errors.append(error) }
		do { self.bool = try container.decode(default: self.bool, key: "bool") } catch { errors.append(error) }
...
extension TestClass_notEmpty {
	...
	func decode(happyFrom decoder: Decoder) throws {
		...
		do { self.int = try container.decode(default: self.int, key: "int") } catch { errors.append(error) }
		do { self.object = try container.decode(default: self.object, key: "object") } catch { errors.append(error) }
		do { self.objectNil = try container.decode(default: self.objectNil, key: "objectNil") } catch { errors.append(error) }
...
extension TestClass_notEmpty.Class {
	...
	func decode(happyFrom decoder: Decoder) throws {
		...
		do { self.int = try container.decode(default: self.int, key: "int") } catch { errors.append(error) }
		do { self.string = try container.decode(default: self.string, key: "string") } catch { errors.append(error) }
...
extension TestStruct_ForKeyedDecodingContainer.Data {
	...
	func decode(happyFrom decoder: Decoder) throws {
		...
		do { self.data = try container.decode(default: self.data, key: "data") } catch { errors.append(error) }
...
extension TestStruct_withAttribute {
	...
	func decode(happyFrom decoder: Decoder) throws {
		...
		do { self.optional_allow = try container.decode(default: self.optional_allow, key: "optional_allow") } catch {  }
		do { self.optional_notAllow = try container.decode(default: self.optional_notAllow, key: "optional_notAllow") } catch { errors.append(error) }
