...
class CommonTests: XCTestCase {
	...
	func testClass() throws {
		...
		let json1 = try encoder.encode(Package(data: .init(object: object)))

		let object1 = try TestClass_notEmpty.decode(from: json1, designatedPath: "data.object")

		assert(try object1.toJSONString() == jsonString)
